    ...
    <?php require_once 'navbar.php'?>
            ...
            <div class="row">
                ...
                <h1>My Projects</h2>
                    <div class="projectInput">
                        <table id="table-2" class="table table-striped table-dark table-border table-responsive-sm table-responsive-md table-responsive-lg tableSpacing">
                            <thead>
                            <tr>
                                ...
                                <th scope="col">Delete Project<hr></th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php require_once 'myProjectsBackend.php';?>
                            </tbody>
                        </table>
                    </div>
                </div>
        ...
        <div class ="container">
            ...
            <div class="col m-auto">
                    <button type="button" id="newProjectButton" data-toggle="modal" data-target="#newProjectModal">New Project</button>
                </div>
            </div>
        </div>
        </div>
